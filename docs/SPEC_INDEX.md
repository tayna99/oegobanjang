...
| `4단계_모바일디자인토큰_v1.md` | CSS 변수·타이포·터치 타깃·모션 — **v1 토큰 전용** | v1 화면 유지보수 시 (v1 요약은 rules/design.md 부록 A) |
...
> 주의: 토큰·시각 기준은 M2.5부터 v2(`rules/design.md`)로 대체된다. 아래 mock·런 각본 행은 계속 유효.
