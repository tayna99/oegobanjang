  ...
  return (
    <div className="p-5">
      <div className="mb-4 flex items-center justify-between gap-3">
        <h2 className="text-lg font-semibold text-ink">발송 승인 완료</h2>
        <Badge tone="success">승인 기록됨</Badge>
      </div>
      ...
      <Card>
        ...
        {state.evidenceRef && <p className="mt-2 text-sm font-semibold text-primary">판단 기록 {state.evidenceRef}</p>}
      </Card>
