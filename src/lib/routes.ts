...
export const ROUTES = {
  ...
  // New unauthenticated response links use this path; `/r/:token` remains a legacy route.
...
export const ROUTE_PATHS = {
  ...
  // Compatibility path for links issued before the canonical response path.
  responseLinkLegacyAbsolute: '/r/:token',
