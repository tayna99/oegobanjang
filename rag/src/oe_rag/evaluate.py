...
from .offline_retriever import retrieve_policy_documents

DEFAULT_DATASET_PATH = DATASETS_DIR / "rag_retrieval_cases.jsonl"
DEFAULT_CHUNK_PATH = CHUNKS_DIR / "all_chunks.jsonl"
    ...
    *,
    ...
    if not chunk_path.exists():
        raise FileNotFoundError(
            f"Chunk file not found: {chunk_path}. Run `uv run python -m oe_rag.pipeline` first."
        )
