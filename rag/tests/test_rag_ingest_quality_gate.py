...
from oe_rag import pipeline as ingest_rag_docs
from oe_rag.chunking import chunk_hash
from oe_rag.ingest.raw_ingest import RawIngestor, build_ingestion_report
...
def test_ingest_chunks_keep_row_source_id_when_raw_metadata_has_parent_source_id() -> None:
    ...
    # 신규 계약: chunk_id = {legacy_chunk_id}_{내용해시8} — 멱등 upsert용
    expected_prefix = "eps_employer_process_procedure_step_0007_chunk_0000"
    assert chunks[0]["chunk_id"] == f"{expected_prefix}_{chunk_hash(chunks[0]['text'])}"
