...
class ApprovalBiometricNotRegisteredError(ApprovalError):
    """identity_method='biometric'인데 users.biometric_registered=false — 422(§13-12)."""

    def __init__(self) -> None:
        super().__init__("생체 인증이 등록되지 않았습니다")
