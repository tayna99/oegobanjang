...
if __name__ == "backend.app.models.document":
    sys.modules.setdefault("app.models.document", sys.modules[__name__])
elif __name__ == "app.models.document":
    sys.modules.setdefault("backend.app.models.document", sys.modules[__name__])
