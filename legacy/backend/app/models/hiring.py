...
if __name__ == "backend.app.models.hiring":
    sys.modules.setdefault("app.models.hiring", sys.modules[__name__])
elif __name__ == "app.models.hiring":
    sys.modules.setdefault("backend.app.models.hiring", sys.modules[__name__])
